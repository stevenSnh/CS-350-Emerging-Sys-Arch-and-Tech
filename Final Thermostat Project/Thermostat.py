    ...
    def updateLights(self):
        ...
        if self.current_state.id == "heat":
            if temp < self.setPoint:
                redLight.blink(fade_in_time = 1, fade_out_time = 1, background = True)
            ...
            if temp > self.setPoint:
                blueLight.blink(fade_in_time = 1, fade_out_time = 1, background = True)
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                ...
                lcd_line_2 = f"{self.current_state.id.title()} Set:{self.setPoint}F\n"
